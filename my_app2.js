...
// const wallets = [
    ...
    const walletAddress =  '0xC237303710a8DFe883f1CF642e60A20c77428C0E';
    ...
    for(i=st;i<runTimes;i++){
        // for (let walletNo in wallets){
            // tasks.push(
                ...
                await addSoldProduct(`B-${i}`,"FARZ-1",hash, walletAddress)
            // );
        // }
    }
    console.timeEnd('codezup')
...
// test()
// getModel("FARZ-1",walletAddress)
// addSoldProduct("FAR-1","FAR-1",hash,walletAddress);
// getBusiness("0xC237303710a8DFe883f1CF642e60A20c77428C0E",walletAddOwner);
// addBuiness("0xC237303710a8DFe883f1CF642e60A20c77428C0E",walletAddOwner)
